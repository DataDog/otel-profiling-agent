...
// example:
// uploadProfiles(profiles, time.Now(), time.Now().Add(60*time.Second), "localhost:8126/v1/profiles")

func uploadProfiles(profiles []profileData, startTime, endTime time.Time, url string, tags []string) error {
...
func buildMultipartForm(profiles []profileData, startTime, endTime time.Time, tags []string) (contentType string, body io.Reader, err error) {
